              ...
              >
                ...
                <div className="p-5">
                  ...
                  >
                    ...
                    {doc.id === 1 ? 'Needfinding PDF' : 'Download PDF'}
                  </a>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          ...
          <div>
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
              ...
              {/* Important Notice */}
              <div className="mb-5 bg-gradient-to-r from-purple-50 to-indigo-50 border-l-4 border-purple-500 rounded-lg p-4 shadow-sm">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <p className="text-sm font-medium text-purple-900">
                      📌 Please proceed with the Hi-Fi prototype in the order shown in the demo video. 
                      <span className="block mt-1">At each step, follow the guide indicated by the <span className="font-bold text-purple-700">purple box</span>.</span>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <div className="aspect-video bg-gray-900 rounded-xl overflow-hidden mb-5">
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/rQjyhfQbLaM"
              ...
              <div className="flex flex-wrap gap-2.5">
                ...
                <a
                  href="https://www.youtube.com/watch?v=rQjyhfQbLaM"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-6 py-2.5 bg-red-600 text-white rounded-full font-medium hover:bg-red-700 transition-colors text-sm"
                >
